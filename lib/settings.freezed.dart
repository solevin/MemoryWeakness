...
class _$_Settings with DiagnosticableTreeMixin implements _Settings {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('databaseVersion', databaseVersion))
      ..add(DiagnosticsProperty('createTableSQL', createTableSQL))
      ..add(DiagnosticsProperty('insertRecordSQL', insertRecordSQL))
      ..add(DiagnosticsProperty('isInitDatabase', isInitDatabase))
      ..add(DiagnosticsProperty('isShowDatabaseViewer', isShowDatabaseViewer));
  }
